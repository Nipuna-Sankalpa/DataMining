...
with open('/home/yellowflash/semester_7/DM/Digit recognizer/train.csv', 'r') as reader:
    reader.readline()
    train_label = []
    train_data = []
...
net = buildNetwork(784, 500, 10, bias=True)
...
with open('/home/yellowflash/semester_7/DM/Digit recognizer/test.csv', 'r') as reader:
    reader.readline()
    test_data = []
    for line in reader.readlines():
